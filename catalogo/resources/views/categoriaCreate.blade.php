...
<main>
    <div class="mx-auto max-w-4xl py-12 px-8">
        ...
        <h1 class="text-2xl font-bold">Alta de una Categoria</h1>
            ...
            @csrf
                <div class="p-6">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <label for="catNombre" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-teal-600 peer-focus:dark:text-teal-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nombre de la categoria</label>
                        @if( $errors->has('catNombre') )
                            <span class="text-sm text-rose-400">
                                {{ $errors->first('catNombre') }}
                            </span>
                        @endif
                    </div>
